...
namespace MvcMovie.Controllers
{
    public class MoviesController : Controller
    {
        ...
        // GET: Movies
        // GET: Movies
        public async Task<IActionResult> Index(string movieGenre, string searchString, string selectedReleaseDate)
        {
            ...
            {
                if (int.TryParse(selectedReleaseDate, out int year))
                {
            ...
            var movieGenreVM = new MovieGenreViewModel
            {
                ...
                SelectedReleaseDate = selectedReleaseDate // Persist selected year
            };
